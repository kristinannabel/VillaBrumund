...
<?php if ( have_posts() ) : ?>
		...
		<h2 class="page-title"><?php _e( 'Søkeresultater:', 'sandbox' ) ?> <span><?php the_search_query() ?></span></h2>
...
<?php else : ?>
			...
			<div id="post-0" class="post no-results not-found">
				<h2 class="entry-title"><?php _e( 'Søket ga ingen resultater', 'sandbox' ) ?></h2>
				<div class="entry-content">
					<p><?php _e( 'Beklager, men vi fant ikke det du søkte etter. Vennligst prøv igjen med et annet nøkkelord.', 'sandbox' ) ?></p>
				</div>
